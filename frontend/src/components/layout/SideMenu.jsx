...
// 2. Added useSelector here (you were using it but hadn't imported it)
...
const SideMenu = ({ setView, view, onOpenEditProfile }) => {
  ...
  const handleFavouriteClick = () => {
    if (!isAuthenticated) {
      // 3. Fixed typo: changed openAuthModel to openAuthModal
      dispatch(openAuthModal("login")); 
      return;
    }
    setView("favourite");
    ...
    <>
      <aside className="sidemenu-root">
        <div className="sidemenu-header">
          ...
          <h2 className="sidemenu-logo-title">Muzio</h2>
        </div>
        ...
        <div className="sidemenu-profile-row">
          ...
          <div className="sidemenu-username-wrapper">
            {/* 4. Changed hardcoded "Guest" to use your displayUser variable */}
